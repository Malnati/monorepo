        ...
        <div className="px-4 pt-3 pb-0">
          <div className="flex relative">
            ...
            >
              ...
              <span className="uppercase tracking-wide">{TAB_VENDIDOS_TEXT}</span>
              {activeTab === 'vendidos' && (
            ...
            >
              ...
              <span className="uppercase tracking-wide">{TAB_COMPRADOS_TEXT}</span>
              {activeTab === 'comprados' && (
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-[#2D0F55] dark:bg-[#8B5CF6]" />
              )}
            </button>
            ...
            >
              ...
              <span className="uppercase tracking-wide">{TAB_EXTRATO_TEXT}</span>
              {activeTab === 'extrato' && (
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-[#2D0F55] dark:bg-[#8B5CF6]" />
              )}
            </button>

-- app/db/init/migrations/modular/ddl/006_ddl_tb_fotos.sql
...
-- Índice para performance em consultas por offer
CREATE INDEX IF NOT EXISTS idx_tb_fotos_offer_id ON tb_fotos(offer_id);

...
1. **Princípios:**
   - Clareza acima da estética
   - Propósito sobre aparência
   - Economia visual (apenas o essencial)
   - Consistência de estilo
   - Leitura imediata (<3s)

2. **Proibições:**
   - Brilhos, sombras excessivas, reflexos
   - Degradês sem propósito funcional
   - Animações lentas ou distrativas
   - Excesso de cores/efeitos competindo

3. **Estilo recomendado:**
   - Cores sólidas e neutras (60-30-10)
   - Tipografia clara (4x2)
   - Espaçamento previsível (8pt Grid)
   - Ícones simples e vetoriais
...
4. **Consistência:** Verificar alinhamento com sistema visual

...
## Propósito
Use este documento como modelo para registrar o requisito "Fase 04 — Testes e Validação" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Fase 04 — Testes e Validação — Especificação Evolutiva](./README-spec.md)

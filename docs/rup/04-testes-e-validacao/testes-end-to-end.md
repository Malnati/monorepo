...
## Propósito
Use este documento como modelo para registrar o requisito "Testes End-to-End" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Testes End-to-End — Especificação Evolutiva](./testes-end-to-end-spec.md)

...
## Propósito
Use este documento como modelo para registrar o requisito "Critérios de Aceitação" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Critérios de Aceitação — Especificação Evolutiva](./criterios-de-aceitacao-spec.md)

...
# Build e Automação (Histórico)

## Propósito
Use este documento como modelo para registrar o requisito "Build e Automação (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Build e Automação (Histórico) — Especificação Evolutiva](./build-e-automacao-spec.md)

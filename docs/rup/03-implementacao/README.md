...
# Implementação — Registro Histórico

## Propósito
Use este documento como modelo para registrar o requisito "Implementação — Registro Histórico" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Implementação — Registro Histórico — Especificação Evolutiva](./README-spec.md)

...
# Padrões de Código (Histórico)

## Propósito
Use este documento como modelo para registrar o requisito "Padrões de Código (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Padrões de Código (Histórico) — Especificação Evolutiva](./padroes-de-codigo-spec.md)

...
# Estrutura de Projeto (Histórico)

## Propósito
Use este documento como modelo para registrar o requisito "Estrutura de Projeto (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Estrutura de Projeto (Histórico) — Especificação Evolutiva](./estrutura-de-projeto-spec.md)

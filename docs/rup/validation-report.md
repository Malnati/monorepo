...
## Propósito
Use este documento como modelo para registrar o requisito "🧩 Relatório de Validação do Diretório `docs/rup/` — App — CLImate INvestment" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[🧩 Relatório de Validação do Diretório `docs/rup/` — App — CLImate INvestment — Especificação Evolutiva](./validation-report-spec.md)

...
## Propósito
Use este documento como modelo para registrar o requisito "Plano de Automação das Issues e Rastreabilidade via Diretório `docs/rup/`" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`plano-automacao-issues-spec.md`).
...
## Documento evolutivo
[Plano de Automação das Issues e Rastreabilidade via Diretório `docs/rup/` — Especificação Evolutiva](./plano-automacao-issues-spec.md)

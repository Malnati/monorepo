<!-- docs/rup/06-governanca-tecnica-e-controle-de-qualidade/README.md -->
...
- [Governança Técnica](governanca-tecnica-spec.md) — estrutura decisória, papéis e métricas de governança.
- [Controle de Qualidade](controle-de-qualidade-spec.md) — critérios de QA, auditorias visuais e métricas operacionais.
- [Auditoria e Rastreabilidade](auditoria-e-rastreabilidade-spec.md) — políticas de logging, metadados obrigatórios e evidências regulatórias.
- [Catálogo de Relatórios Automatizados](auditoria-e-rastreabilidade-spec.md#catalogo-de-relatorios-automatizados) — artefatos produzidos pelos pipelines e agentes IA.
- [Revisões com IA](revisoes-com-ia-spec.md) — orquestração dos agentes IA e workflows GitHub Actions.
- [Relatórios Automatizados](relatorios-automatizados-spec.md) — navegação rápida para os relatórios versionados em `/docs/reports/`.

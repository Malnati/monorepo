<!-- docs/rup/05-operacao-release/versao-e-changelog.md -->
# Versão e Changelog (Histórico)

## Propósito
Use este documento como modelo para registrar o requisito "Versão e Changelog (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Versão e Changelog (Histórico) — Especificação Evolutiva](./versao-e-changelog-spec.md)

<!-- docs/rup/05-operacao-release/publicacao-web-store.md -->
# Publicação (Histórico)

## Propósito
Use este documento como modelo para registrar o requisito "Publicação (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Publicação (Histórico) — Especificação Evolutiva](./publicacao-web-store-spec.md)

<!-- docs/rup/05-operacao-release/ambientes.md -->
# Ambientes (Histórico)

## Propósito
Use este documento como modelo para registrar o requisito "Ambientes (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Ambientes (Histórico) — Especificação Evolutiva](./ambientes-spec.md)

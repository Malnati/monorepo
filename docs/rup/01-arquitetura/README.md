<!-- docs/rup/01-arquitetura/README.md -->
# Fase 01 — Arquitetura

## Propósito
Use este documento como modelo para registrar o requisito "Fase 01 — Arquitetura" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Fase 01 — Arquitetura — Especificação Evolutiva](./README-spec.md)

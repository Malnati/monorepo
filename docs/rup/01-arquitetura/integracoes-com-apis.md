...
## Propósito
Use este documento como modelo para registrar o requisito "Integrações e APIs Externas" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Integrações e APIs Externas — Especificação Evolutiva](./integracoes-com-apis-spec.md)

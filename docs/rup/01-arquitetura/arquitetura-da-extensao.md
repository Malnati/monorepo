...
## Propósito
Use este documento como modelo para registrar o requisito "Arquitetura da Plataforma App" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Arquitetura da Plataforma App — Especificação Evolutiva](./arquitetura-da-extensao-spec.md)

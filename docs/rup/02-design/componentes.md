...
## Propósito
Use este documento como modelo para registrar o requisito "Componentes Detalhados" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Componentes Detalhados — Especificação Evolutiva](./componentes-spec.md)

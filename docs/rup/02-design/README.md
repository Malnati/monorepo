<!-- docs/rup/02-design/README.md -->
# Fase 02 — Design Detalhado

## Propósito
Use este documento como modelo para registrar o requisito "Fase 02 — Design Detalhado" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Fase 02 — Design Detalhado — Especificação Evolutiva](./README-spec.md)

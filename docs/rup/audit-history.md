...
## Propósito
Use este documento como modelo para registrar o requisito "🧾 Histórico de Auditoria da rup — App — CLImate INvestment" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[🧾 Histórico de Auditoria da rup — App — CLImate INvestment — Especificação Evolutiva](./audit-history-spec.md)

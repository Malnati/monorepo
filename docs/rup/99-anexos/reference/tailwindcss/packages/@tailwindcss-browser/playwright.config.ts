...
export default defineConfig({
  ...
  reporter: 'html',
  /* Shared settings for all the projects below. See https://playwright.dev/docs/app/api/class-testoptions. */
  use: {
  ...
  projects: [
    ...
    },
    {
      ...
      use: {
        ...
        launchOptions: {
          // https://playwright.dev/docs/app/api/class-browsertype#browser-type-launch-option-firefox-user-prefs
          firefoxUserPrefs: {

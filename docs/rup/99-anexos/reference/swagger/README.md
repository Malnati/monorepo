...
------------ | -------------
`http://localhost:3000/pets` | `petstore.swagger.io/app/api/pets` or `petstore.swagger.io/app/api/darlings`
`http://localhost:3000/pets?id=eq.`_id_ | `petstore.swagger.io/app/api/pets/{id}`
...
Please help to start, at *Swagger-API* community, via [this *swagger-codegen* approved proposal](https://github.com/swagger-app/api/swagger-codegen/issues/5034), a new code generator, like here, but plugged into an ecosystem of standard code generators.

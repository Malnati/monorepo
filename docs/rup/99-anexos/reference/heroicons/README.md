...
[Browse the full list of icon names on UNPKG &rarr;](https://dominio.com.browse/@heroicons/react/24/outline/)
...
[Browse the full list of icon names on UNPKG &rarr;](https://dominio.com.browse/@heroicons/vue/24/outline/)

<!-- docs/rup/README.md -->
# Template APP — Base RUP

## Propósito
Use este documento como modelo para registrar o requisito raiz do template. Ele explica o objetivo do acervo, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Template APP — Especificação Evolutiva](./README-spec.md)

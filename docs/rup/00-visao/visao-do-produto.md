...
## Propósito
Use este documento como modelo para registrar o requisito "Visão do Produto — App — CLImate INvestment" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Visão do Produto — App — CLImate INvestment — Especificação Evolutiva](./visao-do-produto-spec.md)

<!-- docs/rup/00-visao/escopo.md -->
# Escopo do App — CLImate INvestment

## Propósito
Use este documento como modelo para registrar o requisito "Escopo do App — CLImate INvestment" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Escopo do App — CLImate INvestment — Especificação Evolutiva](./escopo-spec.md)

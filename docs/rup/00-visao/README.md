...
# Fase 00 — Visão do Projeto

## Propósito
Use este documento como modelo para registrar o requisito "Fase 00 — Visão do Projeto" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Fase 00 — Visão do Projeto — Especificação Evolutiva](./README-spec.md)

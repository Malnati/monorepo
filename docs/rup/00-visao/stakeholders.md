<!-- docs/rup/00-visao/stakeholders.md -->
# Stakeholders do App — CLImate INvestment

## Propósito
Use este documento como modelo para registrar o requisito "Stakeholders do App — CLImate INvestment" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Stakeholders do App — CLImate INvestment — Especificação Evolutiva](./stakeholders-spec.md)

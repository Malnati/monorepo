...
Este catálogo consolida os requisitos funcionais, não funcionais, técnicos e legais do **App — CLImate INvestment**. Cada item mantém o identificador `REQ-###`, garantindo rastreabilidade direta com riscos, planos, políticas e changelogs alinhados às fases do RUP.

A especificação completa de contexto, personas e fluxos permanece documentada em [`especificacao-de-requisitos.md`](especificacao-de-requisitos-spec.md) e no inventário de negócios [`requisitos-banco-digital.md`](requisitos-banco-digital-spec.md).
...
| <a id="req-002"></a>REQ-002 | Captura de dados cadastrais completos (organização, unidades, perfis financeiros) com trilha de auditoria e versionamento. | Construção | [`requisitos-banco-digital.md`](requisitos-banco-digital-spec.md#cadastro-de-entidades) | Em elaboração |
| <a id="req-003"></a>REQ-003 | Gestão de lotes de resíduos e marketplace de negociação com regras de matching, precificação dinâmica e contratos digitais. | Construção | [`../02-design/fluxos.md`](../02-design/fluxos-spec.md#fluxo-3-marketplace-de-residuos) · [`requisitos-banco-digital.md`](requisitos-banco-digital-spec.md#listagem-de-ativos) | Em elaboração |
| <a id="req-004"></a>REQ-004 | Orquestração logística com cadastro de frota, seguros, rotas sugeridas e contratação de transporte via plataforma. | Construção | [`requisitos-banco-digital.md`](requisitos-banco-digital-spec.md#veiculo--logistica--transportador-para-integracao-tms) | Planejado |
| <a id="req-005"></a>REQ-005 | Passaporte digital de resíduos consolidando histórico, certificados, medições de qualidade e anexos legais auditáveis. | Construção | [`../99-anexos/referencias.md`](../99-anexos/referencias-spec.md) · [`requisitos-banco-digital.md`](requisitos-banco-digital-spec.md#compliance--certificados) | Planejado |
...
| <a id="req-007"></a>REQ-007 | Produtos financeiros climáticos (crédito verde, antecipação de recebíveis, contas remuneradas) integrados à carteira digital. | Construção | [`../00-visao/visao-do-produto.md`](../00-visao/visao-do-produto-spec.md) · [`./roadmap.md`](roadmap-spec.md#epicos-financeiros) | Planejado |
| <a id="req-008"></a>REQ-008 | Liquidação financeira com split automático e distribuição de incentivos para cooperativas e catadores. | Transição | [`../05-entrega-e-implantacao/publicacao-e-versionamento.md`](../05-entrega-e-implantacao/publicacao-e-versionamento-spec.md) · [`../05-entrega-e-implantacao/operacao-e-manutencao.md`](../05-entrega-e-implantacao/operacao-e-manutencao-spec.md) | Planejado |
...
| <a id="req-010"></a>REQ-010 | Comunidade colaborativa com trilha de capacitação, mensagens e suporte inteligente para cooperativas e parceiros. | Construção | [`../06-ux-brand/diretrizes-de-ux.md`](../06-ux-brand/diretrizes-de-ux-spec.md) · [`requisitos-banco-digital.md`](requisitos-banco-digital-spec.md#niveis-de-acesso) | Planejado |
...
| <a id="req-032"></a>REQ-032 | Roteamento automático para analistas socioambientais, financeiros e jurídicos conforme perfil da operação. | Construção | [`capacidade-diagnostico-colaborativo.md`](capacidade-diagnostico-colaborativo-spec.md#personas-envolvidas) | Proposto |
...
| <a id="req-401"></a>REQ-401 | Notificação transacional automática por e-mail para fornecedores e compradores após confirmação de transação. | Construção | [`../99-anexos/MVP/plano-integration-gmail.md`](../99-anexos/MVP/plano-integration-gmail.md) · [`../01-arquitetura/integracoes-com-apis.md`](../01-arquitetura/integracoes-com-apis-spec.md) | Em elaboração |
| <a id="req-402"></a>REQ-402 | Mensagem de e-mail contendo resumo do lote (nome, quantidade, unidade, valor), dados de contato e número da transação. | Construção | [`../99-anexos/MVP/plano-integration-gmail.md`](../99-anexos/MVP/plano-integration-gmail.md) · [`../06-ux-brand/diretrizes-de-ux.md`](../06-ux-brand/diretrizes-de-ux-spec.md) | Em elaboração |
| <a id="req-403"></a>REQ-403 | Campos de e-mail nas entidades tb_fornecedor e tb_comprador com validação regex e índices para performance. | Construção | [`../99-anexos/MVP/MODEL.md`](../99-anexos/MVP/MODEL.md) · [`../03-implementacao/estrutura-de-projeto.md`](../03-implementacao/estrutura-de-projeto-spec.md) | Em elaboração |
| <a id="req-404"></a>REQ-404 | Seeds de teste com contatos sequenciais dominio.com.br até user10@dominio.com.br para validação end-to-end. | Construção | [`../99-anexos/MVP/plano-integration-gmail.md`](../99-anexos/MVP/plano-integration-gmail.md) | Em elaboração |
...
| <a id="req-405"></a>REQ-405 | Integração com Gmail API usando OAuth2 offline com escopo gmail.send para envio de notificações transacionais. | Construção | [`../99-anexos/MVP/plano-integration-gmail.md`](../99-anexos/MVP/plano-integration-gmail.md) · [`../01-arquitetura/integracoes-com-apis.md`](../01-arquitetura/integracoes-com-apis-spec.md) | Em elaboração |
| <a id="req-406"></a>REQ-406 | Logging estruturado de messageId do Gmail para auditoria completa de envios transacionais. | Construção | [`../99-anexos/MVP/plano-integration-gmail.md`](../99-anexos/MVP/plano-integration-gmail.md) · [`../06-governanca-tecnica-e-controle-de-qualidade/auditoria-e-rastreabilidade.md`](../06-governanca-tecnica-e-controle-de-qualidade/auditoria-e-rastreabilidade-spec.md) | Em elaboração |
| <a id="req-407"></a>REQ-407 | Tratamento de falhas no envio de e-mail sem bloquear confirmação de transação (REQ-GMAIL-005). | Construção | [`../99-anexos/MVP/plano-integration-gmail.md`](../99-anexos/MVP/plano-integration-gmail.md) | Em elaboração |
...
| <a id="req-124"></a>REQ-124 | Fluxo de onboarding com ativação por e-mail, incluindo cadastro inicial com status pendente, envio automático de e-mail transacional HTML com link único parametrizado, expiração de token em 24h, página dedicada de ativação na UI com estados visuais (carregando/sucesso/erro/expirado), reenvio controlado (máximo 3 por 24h), auditoria completa de ações (registro/reenvio/ativação/expiração) e conformidade LGPD. | Construção | [`../99-anexos/MVP/plano-onboarding-email.md`](../99-anexos/MVP/plano-onboarding-email.md) · [`../06-ux-brand/diretrizes-de-ux.md`](../06-ux-brand/diretrizes-de-ux-spec.md) · [`CHANGELOG/20251109142100.md`](/CHANGELOG/20251109142100.md) | Implementado |

<!-- docs/rup/02-planejamento/governanca.md -->
# Governança do Projeto

## Propósito
Use este documento como modelo para registrar o requisito "Governança do Projeto" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Governança do Projeto — Especificação Evolutiva](./governanca-spec.md)

<!-- docs/rup/03-agentes-ia/README.md -->
# Agentes de IA (Arquivo Histórico)

## Propósito
Use este documento como modelo para registrar o requisito "Agentes de IA (Arquivo Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Agentes de IA (Arquivo Histórico) — Especificação Evolutiva](./README-spec.md)

...
# Políticas e Regras — Registro Histórico

## Propósito
Use este documento como modelo para registrar o requisito "Políticas e Regras — Registro Histórico" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Políticas e Regras — Registro Histórico — Especificação Evolutiva](./politicas-e-regras-spec.md)

...
# Pipeline de IA — Registro Histórico

## Propósito
Use este documento como modelo para registrar o requisito "Pipeline de IA — Registro Histórico" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Pipeline de IA — Registro Histórico — Especificação Evolutiva](./pipeline-ia-spec.md)

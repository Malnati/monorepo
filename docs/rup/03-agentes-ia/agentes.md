...
# Agentes de IA — Registro Histórico

## Propósito
Use este documento como modelo para registrar o requisito "Agentes de IA — Registro Histórico" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Agentes de IA — Registro Histórico — Especificação Evolutiva](./agentes-spec.md)

...
## Propósito
Use este documento como modelo para registrar o requisito "Fase 05 — Entrega e Implantação" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Fase 05 — Entrega e Implantação — Especificação Evolutiva](./README-spec.md)

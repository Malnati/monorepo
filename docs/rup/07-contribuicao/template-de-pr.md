...
## Propósito
Use este documento como modelo para registrar o requisito "Template de Pull Request" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Template de Pull Request — Especificação Evolutiva](./template-de-pr-spec.md)

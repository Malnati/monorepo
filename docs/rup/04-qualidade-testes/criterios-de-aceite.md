...
## Propósito
Use este documento como modelo para registrar o requisito "Critérios de Aceite (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Critérios de Aceite (Histórico) — Especificação Evolutiva](./criterios-de-aceite-spec.md)

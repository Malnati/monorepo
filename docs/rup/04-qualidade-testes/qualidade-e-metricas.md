...
## Propósito
Use este documento como modelo para registrar o requisito "Qualidade e Métricas (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Qualidade e Métricas (Histórico) — Especificação Evolutiva](./qualidade-e-metricas-spec.md)

...
## Propósito
Use este documento como modelo para registrar o requisito "Plano de Testes (Histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Plano de Testes (Histórico) — Especificação Evolutiva](./testplan-spec.md)

...
### Modificados
- `.github/workflows/prettier.yml` - Atualizado para usar `.prettierignore` da raiz em vez de `.github/workflows/.prettierignore`
...
2. **Atualização do workflow**: Modificado `.github/workflows/prettier.yml` para usar `--ignore-path .prettierignore` (raiz) em vez de `.github/workflows/.prettierignore`
